 ...
 */
@RestController
@RequestMapping("ware/omspaymentinfo")
public class OmsPaymentInfoController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("ware:omspaymentinfo:list")
    ...
    //@RequiresPermissions("ware:omspaymentinfo:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:omspaymentinfo:save")
    ...
    //@RequiresPermissions("ware:omspaymentinfo:update")
    ...
    //@RequiresPermissions("ware:omspaymentinfo:delete")
